...
# Add examples/drive-thru to path for imports
...
def _main_llm() -> llm.LLM:
    # use text-based LLM (gpt-4.1-mini for efficiency)    
    return openai.LLM(model="gpt-4.1-mini", parallel_tool_calls=False, temperature=0.45)
